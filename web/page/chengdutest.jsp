...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="../css/chengdutest.css">
    ...
    <div class="hcxianlu">
        ...
        <div class="xianlu3">
            ...
            <div class="sqart2">
                <ul>
                    <li class="ha he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;成都</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">148.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;武汉</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">98</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;西安</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">243</span> <span class="qi">起</span></div>
                    </li>
                    <li>
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;苏州</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">46.5</span> <span class="qi">起</span></div>
                    </li>
                </ul>
            </div>
            <div class="sqart3">
                <ul>
                    <li class="ha he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;重庆</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">168.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;郑州</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">243</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;天津</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">278.5</span> <span class="qi">起</span></div>
                    </li>
                    <li>
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;青岛</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">254.5</span> <span class="qi">起</span></div>
                    </li>
                </ul>
            </div>
            <div class="sqart4">
                <ul>
                    <li class="ha he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;深圳</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">128.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;厦门</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">299.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;沈阳</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">341</span> <span class="qi">起</span></div>
                    </li>
                    <li>
                        <div class="sh1">成都&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;哈尔滨</div>
