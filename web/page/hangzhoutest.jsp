...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="../css/hangzhoutest.css">
    ...
    <div class="hcxianlu">
        ...
        <div class="xianlu3">
            <div class="sqart1">
                <ul>
                    <li class="ha he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;上海</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">189.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;广州</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">24.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;杭州</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">62.5</span> <span class="qi">起</span></div>
                    </li>
                    <li>
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;南京</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">252</span> <span class="qi">起</span></div>
                    </li>
                </ul>
            </div>
            <div class="sqart2">
                <ul>
                    <li class="ha he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;成都</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">115</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;武汉</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">166.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;西安</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">40.5</span> <span class="qi">起</span></div>
                    </li>
                    <li>
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;苏州</div>
            ...
            <div class="sqart3">
                <ul>
                    <li class="ha he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;重庆</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">118.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;郑州</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">177.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;天津</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">168.5</span> <span class="qi">起</span></div>
                    </li>
                    <li>
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;青岛</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">219.5</span> <span class="qi">起</span></div>
                    </li>
                </ul>
            </div>
            <div class="sqart4">
                <ul>
                    <li class="ha he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;深圳</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">148.5</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;厦门</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">240</span> <span class="qi">起</span></div>
                    </li>
                    <li class="he">
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;沈阳</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">285.5</span> <span class="qi">起</span></div>
                    </li>
                    <li>
                        <div class="sh1">杭州&nbsp;&nbsp;&nbsp;<img src="../img/huoche.jpg" alt="">&nbsp;&nbsp;&nbsp;哈尔滨</div>
                        <div class="sh2"><span class="bh">¥</span> <span class="price">231</span> <span class="qi">起</span></div>
                    </li>
                </ul>
            </div>
        </div>
